...
CityInfo  <- read.csv("D:/BSOS_Anthropology_R_Tutorial/ANTHROPOLOGY_R_TUTORIALS/data/Cityinfo.csv")
str(CityInfo)
```
...
```{r prepare-otter}
otter <- read.csv("D:/BSOS_Anthropology_R_Tutorial/ANTHROPOLOGY_R_TUTORIALS/data/sea_otter_counts_2017&2018_CLEANDATA.csv")
str(otter)
```
